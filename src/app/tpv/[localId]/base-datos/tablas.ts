...
export const TABLAS: DefinicionTabla[] = [
  {
    ...
    seccionUrl: "ajustes",
    campos: [
      { clave: "id", etiqueta: "id", tipo: "id", soloLectura: true },
      ...
      { clave: "planoAlto", etiqueta: "planoAlto", tipo: "numero" },
      { clave: "tema", etiqueta: "tema", tipo: "enum", opciones: ["CLARO", "OSCURO"] },
      { clave: "colorMarca", etiqueta: "colorMarca", tipo: "enum", opciones: ["VERDE", "AZUL", "TERRACOTA", "GRANATE", "PIZARRA"] },
    ],
    cargar: (localId) =>
  ...
  },
  {
    ...
    campos: [
      ...
      { clave: "color", etiqueta: "color", tipo: "enum", opciones: ["neutro", "azul", "ocre", "terracota", "malva", "pizarra"] },
  ...
  },
  {
    ...
    campos: [
      ...
      { clave: "zonaNombre", etiqueta: "zonaNombre", tipo: "texto", soloLectura: true },
      ...
      { clave: "ancho", etiqueta: "ancho", tipo: "numero" },
      { clave: "alto", etiqueta: "alto", tipo: "numero" },
      { clave: "posicionX", etiqueta: "posicionX", tipo: "numero" },
      { clave: "posicionY", etiqueta: "posicionY", tipo: "numero" },
    ],
    cargar: async (localId) => {
      const filas = await prisma.mesa.findMany({
        where: { localId },
  ...
  },
  {
    ...
    campos: [
      ...
      { clave: "ancho", etiqueta: "ancho", tipo: "numero" },
      { clave: "alto", etiqueta: "alto", tipo: "numero" },
      { clave: "rotacion", etiqueta: "rotacion", tipo: "numero" },
    ],
    cargar: (localId) =>
  ...
  },
  {
    ...
    campos: [
      ...
      { clave: "mesaNumero", etiqueta: "mesaNumero", tipo: "texto", soloLectura: true },
      { clave: "camareroId", etiqueta: "camareroId", tipo: "relacion", cargarOpciones: opcionesUsuariosDelLocal, requerido: true },
      { clave: "camareroNombre", etiqueta: "camareroNombre", tipo: "texto", soloLectura: true },
  ...
  },
  {
    ...
    campos: [
      ...
      { clave: "productoNombre", etiqueta: "productoNombre", tipo: "texto", soloLectura: true },
  ...
  },
  {
    ...
    campos: [
      ...
      { clave: "categoriaNombre", etiqueta: "categoriaNombre", tipo: "texto", soloLectura: true },
      { clave: "nombre", etiqueta: "nombre", tipo: "texto", requerido: true },
  ...
  },
  {
    ...
    campos: [
      ...
      { clave: "ingredienteNombre", etiqueta: "ingredienteNombre", tipo: "texto", soloLectura: true },
  ...
  },
  {
    ...
    campos: [
      ...
      { clave: "proveedorNombre", etiqueta: "proveedorNombre", tipo: "texto", soloLectura: true },
      { clave: "fecha", etiqueta: "fecha", tipo: "fecha" },
  ...
  },
  {
    ...
    campos: [
      ...
      { clave: "empleadoNombre", etiqueta: "empleadoNombre", tipo: "texto", soloLectura: true },
